...
setTitle("Kaje Token Generator");
const fs = require("fs");
const mongoose = require("mongoose")
const userN = require("./doc/keySystem")
let licanseKey = "kaje"
async function main() {
  console.clear();
  ...
  let key = prompt("[" + "Doğrulama amaçlı 'kaje' yazınız lütfen. NOT : '' Olmadan kaje yazınız Örnek: kaje".green + "]")
  if(key != "kaje"){
    return console.log('kaje')
  }
  console.log("Kaje Token Generator");
  ...
  if (choice == 1) {
    ...
    console.log("[" + "2".brightBlue + "] 10minemai (10 DK 1 TOKEN)");
    ...
    console.log(
      "[" +
        "!".green +
        "] Tokenleri Sunucuya göndermek istiyormusun (bu özellik çoğu zaman çalışmamaktadır)(Y=evet,N=Hayır) y/n: "
    );
    ...
    let tokensname = prompt(
      "Token username: ( Tokenlerin adı) ( Boş bırakırsanız kendisi otomatik yapar)  "
    );
    let HowTokens = prompt("Kaç tane token oluşturmak isterdiniz ?: ");
    ...
    async function create_accinfos(chrome, disc) {
      ...
      const password = "kaje"; //TÜM OLUSTURDUGUN TOKENLERİN ŞİFRELERİ BU OLACAK
    ...
    console.log("Kardeş Neyin yardımı aq bildigin kullancan xd");
